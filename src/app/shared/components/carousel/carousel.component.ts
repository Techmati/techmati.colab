...
@Component({
  selector: 'z-carousel',
  imports: [EmblaCarouselDirective, ZardButtonComponent],
  template: `
    <div class="relative">
      <div
        emblaCarousel
      ...
      >
        ...
        @if (controls === 'button') {
          ...
          >
            <span class="lucide--chevron-left text-lg"></span>
          </button>
          <button
            type="button"
            z-button
          ...
          >
            <span class="lucide--chevron-right text-lg"></span>
          </button>
          ...
          <div class="mt-2 flex justify-center gap-1">
            @for (dot of dots(); track $index) {
              ...
              >
                <span
                  class="text-lg"
                  [class]="$index === selectedIndex() ? 'ri-circle-fill' : 'ri-circle-line'"
                ></span>
              </button>
            }
          </div>
