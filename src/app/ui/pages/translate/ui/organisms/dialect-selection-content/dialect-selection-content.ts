...
@Component({
  ...
  imports: [DatePipe, ZardSkeletonComponent, DialectSelector],
...
export class DialectSelectionContent {
  ...
  protected readonly data: DialectSelectionData = inject(Z_ALERT_MODAL_DATA) as DialectSelectionData;
  ...
  private readonly contributorVariants = computed(() => this.contributorContext.active()?.variants ?? []);
